...
enum __attribute__((packed)) pbvm_op {
    ...
    PBVM_OP_CASTBOOL,  // Cast to BOOL (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTI8,    // Cast to I8 (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTI16,   // Cast to I16 (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTI32,   // Cast to I32 (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTI64,   // Cast to I64 (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTU8,    // Cast to U8 (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTU16,   // Cast to U16 (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTU32,   // Cast to U32 (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTU64,   // Cast to U64 (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTF32,   // Cast to F32 (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTF64,   // Cast to F64 (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTVEC,   // Cast to VEC (u32 dims; pops: value; pushes: result)
    PBVM_OP_CASTSTR,   // Cast to STR (u32 dims; pops: value; pushes: result)
