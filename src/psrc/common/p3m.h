...
#define P3M_LOADFLAG_IGNOREGEOM  (1 << 0) // ignore verts, norms, inds, and weights
#define P3M_LOADFLAG_IGNORENORMS (1 << 1) // ignore norms only
#define P3M_LOADFLAG_IGNORESKEL  (1 << 2) // ignore weights and bones
#define P3M_LOADFLAG_IGNOREMATS  (1 << 3) // ignore mats and texs
#define P3M_LOADFLAG_IGNORETEXS  (1 << 4) // ignore texs only
#define P3M_LOADFLAG_IGNOREANIMS (1 << 6) // ignore anims and acts
